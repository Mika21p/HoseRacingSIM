(function () {
  ...
  const NAMED_RACE_HALVES = {
    ...
    "fillies-mile": 1,
    "cheveley-park-stakes": 2,
    "vincent-obrien-national-stakes": 1,
    "moyglare-stud-stakes": 1,
    "criterium-international": 2,
    "criterium-de-saint-cloud": 2,
    "irish-one-thousand-guineas": 2,
    "matron-stakes": 1,
    "sun-chariot-stakes": 1,
    "prix-jean-prat": 1,
    "prix-jean-romanet": 2,
    "preis-der-diana": 1,
    ...
    "champagne-stakes-us": 1,
    "frizette-stakes": 1,
    "american-pharoah-stakes": 2,
    "whitney-stakes": 1,
    "pacific-classic": 2,
    "jockey-club-gold-cup": 1,
    "stephen-foster-stakes": 2,
    "florida-derby": 2,
    "santa-anita-derby": 1,
    "arkansas-derby": 2,
    "alabama-stakes": 2,
    "personal-ensign-stakes": 2,
    "hopeful-stakes-us": 1,
    "spinaway-stakes": 1,
    "del-mar-futurity": 1,
    "breeders-futurity-stakes": 1,
    "hollywood-derby": 2,
    "del-mar-debutante": 1,
    "cotillion-stakes": 2,
    "ogden-phipps-stakes": 1,
    "ashland-stakes": 1,
    "spinster-stakes": 1,
    "la-troienne-stakes": 1,
    "caulfield-cup": 2,
    "cox-plate": 2,
    ...
    "al-quoz-sprint": 2,
    "gran-premio-san-isidro": 1,
    "gran-premio-joaquin-s-de-anchorena": 1,
  ...
  const overseasG1Races = [
    ...
    makeOverseasG1Race("fillies-mile", "雌马一哩赛", 10, "草地", "欧洲", 1600, "2岁", "牝马"),
    makeOverseasG1Race("cheveley-park-stakes", "切弗利园锦标", 9, "草地", "欧洲", 1200, "2岁", "牝马"),
    makeOverseasG1Race("vincent-obrien-national-stakes", "文森特奥布莱恩国家锦标", 9, "草地", "欧洲", 1400, "2岁"),
    makeOverseasG1Race("moyglare-stud-stakes", "莫格莱尔牧场锦标", 9, "草地", "欧洲", 1400, "2岁", "牝马"),
    makeOverseasG1Race("criterium-international", "国际准则大赛", 10, "草地", "欧洲", 1600, "2岁"),
    makeOverseasG1Race("criterium-de-saint-cloud", "圣格卢准则大赛", 10, "草地", "欧洲", 2000, "2岁"),
    makeOverseasG1Race("irish-one-thousand-guineas", "爱尔兰一千坚尼", 5, "草地", "欧洲", 1600, "3岁", "牝马"),
    makeOverseasG1Race("matron-stakes", "马特朗锦标", 9, "草地", "欧洲", 1600, "3岁以上", "牝马"),
    makeOverseasG1Race("sun-chariot-stakes", "太阳战车锦标", 10, "草地", "欧洲", 1600, "3岁以上", "牝马"),
    makeOverseasG1Race("prix-jean-prat", "让普拉特大赛", 7, "草地", "欧洲", 1400, "3岁"),
    makeOverseasG1Race("prix-jean-romanet", "让罗马内大赛", 8, "草地", "欧洲", 2000, "4岁以上", "牝马"),
    makeOverseasG1Race("preis-der-diana", "戴安娜大赛", 8, "草地", "欧洲", 2200, "3岁", "牝马"),
    ...
    makeOverseasG1Race("champagne-stakes-us", "香槟锦标", 10, "泥地", "美国", 1600, "2岁"),
    makeOverseasG1Race("frizette-stakes", "弗里泽特锦标", 10, "泥地", "美国", 1600, "2岁", "牝马"),
    makeOverseasG1Race("american-pharoah-stakes", "美国法老锦标", 9, "泥地", "美国", 1700, "2岁"),
    makeOverseasG1Race("whitney-stakes", "惠特尼锦标", 8, "泥地", "美国", 1800, "4岁以上"),
    makeOverseasG1Race("pacific-classic", "太平洋经典赛", 8, "泥地", "美国", 2000, "3岁以上"),
    makeOverseasG1Race("jockey-club-gold-cup", "赛马会金杯", 9, "泥地", "美国", 2000, "3岁以上"),
    makeOverseasG1Race("stephen-foster-stakes", "斯蒂芬福斯特锦标", 6, "泥地", "美国", 1800, "3岁以上"),
    makeOverseasG1Race("florida-derby", "佛罗里达德比", 3, "泥地", "美国", 1800, "3岁"),
    makeOverseasG1Race("santa-anita-derby", "圣雅尼塔德比", 4, "泥地", "美国", 1800, "3岁"),
    makeOverseasG1Race("arkansas-derby", "阿肯色德比", 3, "泥地", "美国", 1800, "3岁"),
    makeOverseasG1Race("alabama-stakes", "阿拉巴马锦标", 8, "泥地", "美国", 2000, "3岁", "牝马"),
    makeOverseasG1Race("personal-ensign-stakes", "个人旌旗锦标", 8, "泥地", "美国", 1800, "3岁以上", "牝马"),
    makeOverseasG1Race("hopeful-stakes-us", "美国希望锦标", 9, "泥地", "美国", 1400, "2岁"),
    makeOverseasG1Race("spinaway-stakes", "斯宾纳韦锦标", 9, "泥地", "美国", 1400, "2岁", "牝马"),
    makeOverseasG1Race("del-mar-futurity", "德尔马未来锦标", 9, "泥地", "美国", 1400, "2岁"),
    makeOverseasG1Race("breeders-futurity-stakes", "育马者未来锦标", 10, "泥地", "美国", 1700, "2岁"),
    makeOverseasG1Race("hollywood-derby", "好莱坞德比", 11, "草地", "美国", 1800, "3岁"),
    makeOverseasG1Race("del-mar-debutante", "德尔马初登场锦标", 9, "泥地", "美国", 1400, "2岁", "牝马"),
    makeOverseasG1Race("cotillion-stakes", "科蒂利恩锦标", 9, "泥地", "美国", 1700, "3岁", "牝马"),
    makeOverseasG1Race("ogden-phipps-stakes", "奥格登菲普斯锦标", 6, "泥地", "美国", 1800, "4岁以上", "牝马"),
    makeOverseasG1Race("ashland-stakes", "阿什兰锦标", 4, "泥地", "美国", 1700, "3岁", "牝马"),
    makeOverseasG1Race("spinster-stakes", "斯宾斯特锦标", 10, "泥地", "美国", 1800, "3岁以上", "牝马"),
    makeOverseasG1Race("la-troienne-stakes", "拉特洛耶纳锦标", 5, "泥地", "美国", 1700, "4岁以上", "牝马"),
    makeOverseasG1Race("caulfield-cup", "考菲尔德杯", 10, "草地", "澳洲", 2400, "3岁以上"),
    makeOverseasG1Race("cox-plate", "觉士盾", 10, "草地", "澳洲", 2040, "3岁以上"),
    makeOverseasG1Race("golden-slipper-stakes", "金拖鞋大赛", 3, "草地", "澳洲", 1200, "3岁"),
    ...
    makeOverseasG1Race("saudi-cup", "沙特杯", 2, "泥地", "中东", 1800, "4岁以上"),
    makeOverseasG1Race("neom-turf-cup", "尼奥姆草地杯", 2, "草地", "中东", 2100, "3岁以上"),
    makeOverseasG1Race("al-maktoum-challenge", "马克图姆挑战赛", 1, "泥地", "中东", 1900, "4岁以上"),
    makeOverseasG1Race("jebel-hatta", "杰贝哈塔锦标", 1, "草地", "中东", 1800, "4岁以上"),
    ...
    makeOverseasG1Race("gran-premio-san-isidro", "圣伊西德罗大赛", 10, "草地", "阿根廷", 1600, "3岁以上"),
    makeOverseasG1Race("gran-premio-joaquin-s-de-anchorena", "华金S.德安乔雷纳大赛", 12, "草地", "阿根廷", 1600, "3岁以上"),
