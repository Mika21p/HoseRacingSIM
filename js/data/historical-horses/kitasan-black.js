(function () {
  ...
  ns.HistoricalHorseRegistry.register({
    ...
    races: [
      { raceId: "spring-stakes", year: 2015, ability: 84, jockeyId: "generic-local", finish: 1 },
      { raceId: "st-lite-kinen", year: 2015, ability: 85, jockeyId: "generic-local", finish: 1 },
      { raceId: "kikka-sho", year: 2015, ability: 86, jockeyId: "generic-local", finish: 1 },
